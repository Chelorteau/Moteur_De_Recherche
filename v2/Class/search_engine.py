...
class SearchEngine:
    def __init__(self, source):
        ...
        self.vocab = {}
        self.mat_TF = None
        self.documents = []  # Liste de tous les documents pour un accès facile
    ...
    def _build_vocab_and_matrix(self):
        ...
        """
        rows, cols, data = [], [], []
        vocab_index = {}  # Dictionnaire pour associer mots à leurs indices
        current_doc_id = 0
    ...
    def search(self, query, nb_doc=5):
        """
